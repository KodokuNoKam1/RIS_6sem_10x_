...
/* 
Ввод из файла, вывод в консоль node index.js -t uppercase -i input.txt
Ввод из файла, вывод в файл node index.js -t reverse -i input.txt -o output.txt
Ввод вручную, вывод в консоль node index.js -t trim
Ввод вручную, вывод в файл node index.js -t capitalize -o output.txt

Считываем переменную n,
если n - целое число, возвращать строку с дефисом '-' перед каждым нечетным
целым числом и после него, но не начинать и не заканчивать строку знаком тире. Если
n отрицательное, знак минус следует удалить.
